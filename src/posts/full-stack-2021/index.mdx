...
<CS>
  ...
  <h3>
    ...
    <p>
      ...
      to get started with is to set up a store with the <code>create</code>{" "}
      ...
      about the{" "}
      <a href="https://github.com/pmndrs/zustand#first-create-a-store">
        Zustand API
      </a>
      .
    </p>
    No providers
    <p>
      Unlike other state management solutions such as Reacts own{" "}
      <a href="https://reactjs.org/docs/context.html">Context API</a>, Zustand
      doesn't need to have all the children receiving the state to be wrapped in
      a context provider. This makes Zustand incredibly simple and flexible
    ...
    <p>
      ...
      component won't need to re-render with each state change. Learn more about{" "}
      <a href="https://github.com/pmndrs/zustand#transient-updates-for-often-occuring-state-changes">
        transient updates
      </a>
      .
    </p>
